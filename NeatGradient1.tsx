...
// defaultValue for array controls (colors) while still injecting it for
// plain object groups — leaving `colors` empty and the gradient rendering as
// a flat backgroundColor fill. Every field falls back to one of these so no
// rendering context can leave a value undefined (which, worse, would come
