...
const DEFAULT_CONFIG = {
    colors: [
        ...
        { color: "#08649A", enabled: false, influence: 1 },
        { color: "#073977", enabled: false, influence: 1 },
        { color: "#19868A", enabled: false, influence: 1 },
    ],
    speed: 2,
...
export default function BlueMotionBackground(props: any) {
...
addPropertyControls(BlueMotionBackground, {
    ...
    color4: colorSlotControl("Color 4", "#08649A", false),
    color5: colorSlotControl("Color 5", "#073977", false),
    color6: colorSlotControl("Color 6", "#19868A", false),

    movement: {
        type: ControlType.Object,
        title: "Waves",
        controls: {
            speed: { type: ControlType.Number, defaultValue: 2, min: 0, max: 20, step: 0.1 },
            horizontalPressure: { type: ControlType.Number, defaultValue: 5, min: 0, max: 10, step: 0.1 },
            verticalPressure: { type: ControlType.Number, defaultValue: 6, min: 0, max: 10, step: 0.1 },
            waveFrequencyX: { type: ControlType.Number, defaultValue: 1, min: 0, max: 25, step: 0.1 },
            waveFrequencyY: { type: ControlType.Number, defaultValue: 2, min: 0, max: 25, step: 0.1 },
            waveAmplitude: { type: ControlType.Number, defaultValue: 10, min: 0, max: 20, step: 0.1 },
        },
    },
    ...
    light: {
        ...
        title: "Light & Color",
        controls: {
            shadows: { type: ControlType.Number, defaultValue: 0, min: 0, max: 10, step: 0.1 },
            highlights: { type: ControlType.Number, defaultValue: 7, min: 0, max: 10, step: 0.1 },
            colorBrightness: { type: ControlType.Number, defaultValue: 1.05, min: 0, max: 2, step: 0.05 },
            colorSaturation: { type: ControlType.Number, defaultValue: 0, min: 0, max: 10, step: 0.1 },
            colorBlending: { type: ControlType.Number, defaultValue: 9, min: 0, max: 10, step: 0.1 },
    ...
    flow: {
        ...
        controls: {
            enabled: { type: ControlType.Boolean, defaultValue: false },
            distortionA: { type: ControlType.Number, defaultValue: 0.4, min: 0, max: 10, step: 0.1 },
            distortionB: { type: ControlType.Number, defaultValue: 3, min: 0, max: 10, step: 0.1 },
            scale: { type: ControlType.Number, defaultValue: 3.3, min: 0, max: 10, step: 0.1 },
            ease: { type: ControlType.Number, defaultValue: 0.53, min: 0, max: 1, step: 0.01 },
        },
    },
    ...
    scrollOffset: {
        ...
        controls: {
            ...
            waveMultiplier: { type: ControlType.Number, defaultValue: 6.5, min: 0, max: 20, step: 0.1 },
            colorMultiplier: { type: ControlType.Number, defaultValue: 5, min: 0, max: 20, step: 0.1 },
            flowMultiplier: { type: ControlType.Number, defaultValue: 3, min: 0, max: 20, step: 0.1 },
        },
    },
    ...
    texture: {
        ...
        controls: {
            ...
            voidLikelihood: { type: ControlType.Number, defaultValue: 0.06, min: 0, max: 1, step: 0.01 },
            voidWidthMin: { type: ControlType.Number, defaultValue: 10, min: 0, max: 2000, step: 1 },
            voidWidthMax: { type: ControlType.Number, defaultValue: 500, min: 0, max: 2000, step: 1 },
            bandDensity: { type: ControlType.Number, defaultValue: 0.8, min: 0, max: 10, step: 0.05 },
            ...
            ease: { type: ControlType.Number, defaultValue: 0.4, min: 0, max: 1, step: 0.01 },
            backgroundColor: { type: ControlType.Color, defaultValue: "#003FFF" },
