 ...
 * VirtualScrollGeneral, the shared export below — the registry keys on
 ...
 * height, with nothing new to write. Card Alerts is the current
 * exception, kept on its own dedicated export — see the comment on
 * VirtualScrollCardAlertsContent for why — but exceptions like it
 * aren't expected to be the norm.
 *
...
// of habit from before page-scoping existed; collapsed into this one
// now that keeping them distinct was doing no actual work.
//
// Not every page has to use this one — Card Alerts is the current
// exception (see VirtualScrollCardAlertsContent just below for why),
// but exceptions like it aren't expected to be the norm.
export function VirtualScrollGeneral(
